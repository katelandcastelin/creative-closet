...
import Top1Full from '../src/assets/tops/full/1.png';
import Top1Icon from '../src/assets/tops/icon/1.png';
...
import Shoe1Full from '../src/assets/feet/shoes/full/1.png';
import Shoe1Icon from '../src/assets/feet/shoes/icon/1.png';
...
export const subItems = {
  Accessories: [
    {
      category: 'Hats',
      items: [{ full: Hat1Full, icon: Hat1Icon }]
    },
    {
      category: 'Earrings',
      items: [{ full: Earring1Full, icon: Earring1Icon }]
    },
    {
      category: 'Necklaces',
      items: [{ full: Necklace1Full, icon: Necklace1Icon }]
    },
  ],
  Feet: [
    {
    ...
    {
      category: 'Socks',
      items: [{ full: Socks1Full, icon: Socks1Icon }]
    },
  ],
}